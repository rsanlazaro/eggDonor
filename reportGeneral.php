...
<div></div>';
    ...
    if (isset($imageUrl1) && strlen($imageUrl1)>5) {
        $html2 = $html2 . '<img class="img1" src="data:image/png;base64,' . $imageData1 . '" height="500"/>
        <br>';
    }

    if (isset($imageUrl2) && strlen($imageUrl2)>5) {
        $html3 = $html3 . '<img class="img2" src="data:image/png;base64,' . $imageData2 . '" height="500"/>
    <br>';
    }

    if (isset($imageUrl3) && strlen($imageUrl3)>5) {
        $html4 = $html4 . '<img class="img2" src="data:image/png;base64,' . $imageData3 . '" height="500"/>
    <br>';
    }

    if (isset($imageUrl4) && strlen($imageUrl4)>5) {
        $html5 = $html5 . '<img class="img3" src="data:image/png;base64,' . $imageData4 . '" height="500"/>';
    }
